package cn.demomaster.qdrouter_library.util;
...
public class DisplayUtil {
    ...
    public static int getStatusBarHeight(Context context) {
        ...
        try {
            ...
            e.printStackTrace();
            status_bar_height = dip2px(context,24);//(int) context.getResources().getDimension(R.dimen.activity_statebar_height);
            return status_bar_height;
        }
        return 0;
    }
    ...
    public static int getActionbarHeight(Context context) {
        ...
        if (actionBarHeight == 0) {
            ...
            actionBarHeight = dip2px(context,24);
            return actionBarHeight;
        }
        return 0;
    }
